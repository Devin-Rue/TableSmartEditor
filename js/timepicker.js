			...
			if ($dp.find("div.ui-timepicker-div").length === 0 && o.showTimepicker) {
				var noDisplay = ' style="display:none;"',
					html = '<div class="ui-timepicker-div"><dl>' + '<dt class="ui_tpicker_time_label"' + ((o.showTime) ? '' : noDisplay) + '>' + o.timeText + '</dt>' +
								'<dd style="display:inline-block;margin-left: 10px;" class="ui_tpicker_time"' + ((o.showTime) ? '' : noDisplay) + '></dd><br />';
				...
				if (o.timeOnly === true) {
				    $tp.prepend('<div class="ui-widget-header ui-helper-clearfix ui-corner-all">' + '<div class="ui-datepicker-title" style="margin-left:10px;">' + o.timeOnlyTitle + '</div>' + '</div>');
